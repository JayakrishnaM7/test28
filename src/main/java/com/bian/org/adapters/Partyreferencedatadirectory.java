...
@Component
public class Partyreferencedatadirectory implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private PartyReferenceDatadirectoryRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Partyreferencedatadirectory.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Partyreferencedatadirectory.class.getName());
         }else{
